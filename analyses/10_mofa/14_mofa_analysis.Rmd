...
svg(file.path(nxfvars$out_dir, "plots", "heatmap_bootstrapped.svg"), width = 15, height = 20)
...
plots <- lapply(names(factor_list), function(factors_name) {
  ...
  svg(
    filename = file.path(nxfvars$out_dir, "plots", sprintf("%s_factor_correlations.svg", factors_name)),
