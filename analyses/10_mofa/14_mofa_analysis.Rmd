...
tmp_scatter_data %>%
  ...
  geom_label_repel(size = 3.5, max_overlaps=200, data = tmp_scatter_data %>% filter(JiaSharma > 0.5 | NSCLC > 0.5 | NSCLC < -0.3 | JiaSharma < -0.3), aes(label = feature)) +
