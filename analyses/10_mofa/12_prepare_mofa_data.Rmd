...
saveRDS(data_all_tidy, file = file.path(nxfvars$out_dir, "data_all_tidy.rds"), compress = FALSE)
```
...
lapply(names(feature_data), function(dataset_id) {
  saveRDS(feature_data[[dataset_id]], file = file.path(nxfvars$out_dir, paste0("mofa_", dataset_id, ".rds")), compress = FALSE)
})
```
