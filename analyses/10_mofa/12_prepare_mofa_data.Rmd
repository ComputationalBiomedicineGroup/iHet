...
DATASETS <- c("Jia", "Sharma", "LUAD", "LUSC", "GTEx")
...
```{r}
for (feature in unique(feature_data$Jia$view)) {
  generateHeatmap(feature_data$Jia %>% filter(view == !!feature), feature, row_names = TRUE)
}
```
